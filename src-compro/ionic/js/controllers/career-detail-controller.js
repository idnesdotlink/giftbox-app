app.controller("CareerDetailCtrl", function ($scope,
                                            $rootScope,
                                            $http,
                                            httpService,
                                            $stateParams,
    ...
    $scope.applied = false;
    $scope.appliedText = 'Apply';
    $scope.canApplyCareer = true;
    $scope.isLoginEnabled = isLoginEnabled;

    var loadCustomText = function() {
        $scope.ui_text_apply_career = "Apply";
        $scope.ui_text_applied_career = "Thank you for applying.";
        $scope.ui_text_apply_career_success = "Applying Job Success";
        $scope.ui_text_apply_career_failed = "Applying Job Failed. Please Check Your Internet Connection and Try Again";
        $scope.ui_text_please_login = "Please login to apply";
        $scope.button_text_login_now = "Login Now";
        $scope.title_text_applying_career = "Applying Job";
        $scope.title_text_login = "Login";

        $scope.ui_text_apply_career = $scope.appliedText = getMenuText(ui_texts_careers.ui_text_apply_career,"Apply");
        $scope.ui_text_applied_career = getMenuText(ui_texts_careers.ui_text_applied_career,"Thank you for applying.");
        $scope.ui_text_apply_career_success = getMenuText(ui_texts_careers.ui_text_apply_career_success,'Successfully applied job!');
        $scope.ui_text_apply_career_failed = getMenuText(ui_texts_careers.ui_text_apply_career_failed,'Failed to apply job. Please check your internet connection and try again.');
        $scope.ui_text_please_login = getMenuText(ui_texts_careers.ui_text_please_login, "Please login to apply");
        $scope.button_text_login_now = getMenuText(ui_texts_careers.button_text_login_now,'Login Now');
        $scope.title_text_applying_career = getMenuText(ui_texts_careers.title_text_applying_career,'Applying Job');
        $scope.title_text_login = getMenuText(ui_texts_careers.title_text_login,"Login");


        // ui_text_apply_career = ui_texts_careers.ui_text_apply_career !== undefined && ui_texts_careers.ui_text_apply_career[language]!==undefined ? ui_texts_careers.ui_text_apply_career[language] : "Apply";
        // $scope.ui_text_apply_career = ui_text_apply_career;
        // $scope.appliedText = ui_text_apply_career;

        // ui_text_applied_career = ui_texts_careers.ui_text_applied_career !== undefined && ui_texts_careers.ui_text_applied_career[language]!==undefined ? ui_texts_careers.ui_text_applied_career[language] : "Thank you for applying.";
        // $scope.ui_text_applied_career = ui_text_applied_career;
        //
        // ui_text_apply_career_success = ui_texts_careers.ui_text_apply_career_success !== undefined && ui_texts_careers.ui_text_apply_career_success[language]!==undefined ? ui_texts_careers.ui_text_apply_career_success[language] : "Applying Job Success";
        // $scope.ui_text_apply_career_success = ui_text_apply_career_success;
        //
        // ui_text_apply_career_failed = ui_texts_careers.ui_text_apply_career_failed !== undefined && ui_texts_careers.ui_text_apply_career_failed[language]!==undefined ? ui_texts_careers.ui_text_apply_career_failed[language] : "Applying Job Failed. Please Check Your Internet Connection and Try Again";
        // $scope.ui_text_apply_career_failed = ui_text_apply_career_failed;
        //
        // ui_text_please_login = ui_texts_careers.ui_text_please_login !== undefined && ui_texts_careers.ui_text_please_login[language]!==undefined ? ui_texts_careers.ui_text_please_login[language] : "Please login to apply";
        // $scope.ui_text_please_login = ui_text_please_login;
        //
        // button_text_login_now = ui_texts_careers.button_text_login_now !== undefined && ui_texts_careers.button_text_login_now[language]!==undefined ? ui_texts_careers.button_text_login_now[language] : "Login Now";
        // $scope.button_text_login_now = button_text_login_now;
        //
        // title_text_applying_career = ui_texts_careers.title_text_applying_career !== undefined && ui_texts_careers.title_text_applying_career[language]!==undefined ? ui_texts_careers.title_text_applying_career[language] : "Applying Job";
        // $scope.title_text_applying_career = title_text_applying_career;
        //
        // title_text_login = ui_texts_careers.title_text_login !== undefined && ui_texts_careers.title_text_login[language]!==undefined ? ui_texts_careers.title_text_login[language] : "Login Now";
        // $scope.title_text_login = title_text_login;
    }
    ...
    $scope.$on('httpService:getRequestSuccess', function () {
        ...
        $scope.content_data = {
            ...
            career_date: $scope.data.post.career_date,
        ...
        {
            $scope.applied = true;
            $scope.appliedText = $scope.ui_text_applied_career;
        }
...
//        httpService.post_token($scope, $http, url, obj, 'content');
    ...
    $scope.$on('httpService:getHighResDataSuccess', function (event, args) {
        ...
        $scope.content_data = {
            ...
            career_date: updated_data.post.career_date,
        ...
        if(isPhoneGap())
        {
            ...
            savePostJSONToDB($stateParams.id, updated_data.post.term_id, 'CareerDetailCtrl', updated_data);
            //console.log('saved');
        }
    ...
    $scope.$on('httpService:postTokenUserFormSuccess', function () {
        ...
        var obj = serializeData({_method: 'POST', content: 'Applying Career', post_id: $stateParams.id, user_id: user_id, company_id: company_id});
    ...
    $scope.showSubmitFormSuccessAlert = function () {
        var alertPopup = $ionicPopup.alert({
            title: $scope.title_text_applying_career,
            css: 'cp-button',
            okType:'cp-button',
            okText:$scope.alert_button_ok,
            template: '<div style="width:100%;text-align:center">'+$scope.ui_text_apply_career_success+'</div>'
        });
    };
    ...
    $scope.showSubmitFormFailedAlert = function () {
        var alertPopup = $ionicPopup.alert({
            ...
            okType:'cp-button',
            okText:$scope.alert_button_ok,
            template: '<div style="width:100%;text-align:center">'+$scope.ui_text_apply_career_failed+'</div>'
        });
    };
