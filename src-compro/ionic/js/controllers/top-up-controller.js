 ...
 */
app.controller('TopUpCtrl', function ($scope, $state, $ionicLoading, $http, httpService, $stateParams, $ionicPlatform,$ionicPopup) {
    ...
    $ionicPlatform.ready(function () {
        ...
        //console.log(JSON.parse(duration_lists));
...
//                else if (productId === productIds[2]) $scope.topUpAccount(1095);
            ...
            .catch(function (err) {
                ...
                $ionicPopup.alert({
                    ...
                    template: 'Check your internet connection<br/>'+JSON.stringify(err)
                });
            });
...
//        httpService.post($scope, $http, top_up_purchase_url, obj);
    ...
    $scope.$on('SQLite:getSpecialVarsSuccess:1', function () {
